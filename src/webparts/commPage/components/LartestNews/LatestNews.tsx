...
import Forme from './LikesV2/Forme';
                            ...
                            <div className={styles.card} key={index}>
                                ...
                                {commentVisible[index] && (
                                        <div className={styles.CommentPart}>
                                            <textarea value={commentText} id={`subject_${index}`} name={`subject_${index}`} placeholder="Enter your comment..." style={{ height: '100px', fontSize: '11px', background:'#DFF9F1' }} onChange={(e) => setCommentText(e.target.value)}></textarea>
