...
import * as strings from 'HomePageFinaleWebPartStrings';

import './HomePageFinaleWebPart.module.scss';

import HomePage from './components/HomePageFinale';
